...
//        Problem2.ListNode l1 = problem2.ArrayToListNode(new int[]{5});
//        Problem2.ListNode l2 = problem2.ArrayToListNode(new int[]{5});
        //expect [0,1]

//        Problem2.ListNode l1 = problem2.ArrayToListNode(new int[]{9,1,6});
//        Problem2.ListNode l2 =problem2.ArrayToListNode(new int[]{0});
        //expect [9,1,6]

        Problem2.ListNode l1 = problem2.ArrayToListNode(new int[]{3, 7});
        Problem2.ListNode l2 = problem2.ArrayToListNode(new int[]{9, 2});
        //expect [2,0,1]
        problem2.addTwoNumbers1(l1, l2);
    }
}